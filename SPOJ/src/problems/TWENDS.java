...
public class TWENDS {
    ...
    private void run() throws IOException {
        ...
        while (true) {
            ...
            sb.append("In game " + gameNumber++ + ", the greedy strategy might lose by as many as "
                + play(cards, 0, cards.length - 1) + " points.\n");
            // System.out.println("In game " + gameNumber++ + ", the greedy strategy might lose by as many as " +
            // play(cards, 0, cards.size()-1) + " points.");
        }
        System.out.print(sb);
    }
